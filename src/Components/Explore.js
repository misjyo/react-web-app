            ...
            <div className='extra-ct'>
              <table className='table table-extra table-bordered table-striped categry-tble'>
                ...
                <tbody>
                  ...
                  {showbtn ?
                    <tr>
                      <td><button className='btn btn-light view-btn' onClick={() => { setShow(!show); setShowbtn(!showbtn) }}>Show All</button></td>
                    </tr>
                    : null}
                  ...
                  {show ? <>
                    ...
                    <tr>
                      ...
                      <td><button className='btn btn-light view-btn' onClick={() => { setShow(false); setShowbtn(true) }}>Show Less</button></td>
